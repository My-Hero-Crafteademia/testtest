...
package net.mcreator.testgod.item;
...
import net.mcreator.testgod.item.inventory.DNAQuirkSelectorInventoryCapability;
...
public class DNAQuirkSelectorItem extends Item {
	public DNAQuirkSelectorItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("DNA Quirk Selector");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new MenuModMAINMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new DNAQuirkSelectorInventoryCapability();
	}
